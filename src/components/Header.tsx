            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  title={t('header.fw_toggle_title', 'Click to toggle simulated firmware version (v1.0.0 vs v1.1.0)')}
                >
                  <span>FW v{firmwareVersion}</span>
                  <span className="text-[10px] opacity-75">
                    ({firmwareVersion.startsWith('1.0') ? t('header.tools_count_10', '12 Tools') : t('header.tools_count_11', '25 Tools')})
                  </span>
                </button>
              </div>
